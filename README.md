...
| Command | Description |
| ------- | ----------- |
| `git init -b main` | Initialize a local Git repository |
| `git add .` | Adds / stages all of the files in the current directory |
| `git commit -m "first commit"` | Captures a snapshot of the project's currently staged changes |
| `git remote add origin <url>` | A shorthand name for the remote repository that a project was originally cloned from |
